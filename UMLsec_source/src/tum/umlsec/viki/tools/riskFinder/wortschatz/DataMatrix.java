...
public class DataMatrix  implements java.io.Serializable {
     ...
     * @return dataVectors
     */
    public DataVector[] getDataVectors() {
        return dataVectors;
    }
     ...
     * @param dataVectors
     */
    public void setDataVectors(DataVector[] dataVectors) {
        this.dataVectors = dataVectors;
    }

    public DataVector getDataVectors(int i) {
        return this.dataVectors[i];
    }

    public void setDataVectors(int i, DataVector _value) {
