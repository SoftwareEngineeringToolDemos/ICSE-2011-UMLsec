/**
 * Integration of the UML model parser for subsystems and sequence diagrams in the framework viki:
...
public class ToolSequence implements IVikiToolBase, IVikiToolConsole  {
    ...
    public String getToolName() {
        return "Sequence-Diagram Parser";	
    }
    ...
    public void initialiseBase(IMdrContainer _mdrContainer) {
        ...
        commandDepth = CommandDescriptor.CommandDescriptorConsole(CID_SEQUENCE_PARSER, "Parse", "Parse Messages", true, _parameters);
        commands = new Vector();
