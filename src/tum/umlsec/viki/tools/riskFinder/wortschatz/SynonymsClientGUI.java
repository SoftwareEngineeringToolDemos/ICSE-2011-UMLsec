 ...
 */
public class SynonymsClientGUI extends JFrame implements ActionListener {
    ...
    private SynonymsClient objClient = null;
    ...
    public SynonymsClientGUI() {
        
        try{
            objClient = new SynonymsClient();
    ...
    /** This method is csynonymsed from within the constructor to
     * initialize the form.
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if( event.getActionCommand().startsWith( "Load " ) ){
            ...
            int intStatus = objInputFile.showOpenDialog( SynonymsClientGUI.this );
            ...
            for( int i = 0; i < objAttachments.length; i++ ){
                try{
                    ...
                    do{
                        ...
                        intSaveStatus = objSaveDialog.showSaveDialog( SynonymsClientGUI.this );
